//Declare and configure the initial module. 
...
angular.module('pickle-app').config(function($routeProvider) {
    ...
    .when('/all', {
        templateUrl: 'all-users/all-users-view.html', 
        controller: 'get-all-ctrl'
    })
    .when('/search', {
        templateUrl: 'search-user/search-user-view.html',
...
angular.module('pickle-app').service('dataService', ['$http', 
    function($http) {
