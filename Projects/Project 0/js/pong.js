...
var play2RightPressed = false;
var play2LeftPressed = false;
var ballRadius = 20;
...
document.addEventListener("keydown", keyPlay2DownHandler,false);
document.addEventListener("keyup", keyPlay2UpHandler, false);
...
function keyPlay2DownHandler(e){
    if(e.keyCode == 68){
        play2RightPressed = true;
    }
    else if(e.keyCode == 65){
        play2LeftPressed = true;
    }
}

function keyPlay2UpHandler(e){
    if(e.keyCode == 68){
        play2RightPressed = false;
    }
    else if(e.keyCode == 65){
        play2LeftPressed = false;
    }
}
...
function pong(){
    ...
    if(y + dy < ballRadius){
        if (x > paddleX2 && x < paddleX2 + paddleWidth){
            ...
            //document.getElementById('score1').innerHTML = `Player 1: ${score1}`;
            if(score1 == 9){
                //alert("Player 1 WIN! Press OK to restart.");
                //score1 = 0;
                //scorePlay2 = 0;
    ...
    if(play2RightPressed && paddleX2 < canvas.width-paddleWidth){
        paddleX2 += 7;
    }
    else if(play2LeftPressed && paddleX2 > 0){
        paddleX2 -= 7;
    }
